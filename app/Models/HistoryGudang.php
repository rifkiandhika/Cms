...
class HistoryGudang extends Model
{
    ...
    {
        return $this->belongsTo(DetailGudang::class, 'barang_id', 'barang_id');
    }
    ...
    {
        if ($this->detailGudang) {
            return $this->detailGudang->nama_barang;
        }
        return '-';
    }

    // Helper method untuk mendapatkan jenis barang
    public function getJenisBarangAttribute()
    {
        if ($this->detailGudang) {
            return $this->detailGudang->jenis_barang;
        }
        return '-';
    }
