        ...
        <div class="row">
            ...
            <div class="col-xl-8">
                ...
                <div class="card shadow-sm border-0 mb-4">
                    <div class="card-header {{ $po->tipe_po === 'penjualan' ? 'bg-primary' : 'bg-success' }} text-white py-3">
                        <h5 class="mb-0">
            ...
            <div class="col-xl-4">
                ...
                <div class="card shadow-sm border-0 mb-4 position-sticky" style="top: 20px;">
                    ...
                    <div class="card-body">
                        ...
                        <div class="alert {{ $po->tipe_po === 'penjualan' ? 'alert-info' : 'alert-success' }} mt-3 small">
...
confirmPinBtn.addEventListener('click', function () {
    ...
    const destination = tipePO === 'penjualan' ? 'Apotik' : 'Gudang';
    ...
    Swal.fire({
        ...
        html: `
            <div class="text-start">
                ...
                <p class="${tipePO === 'penjualan' ? 'text-primary' : 'text-success'}">
