<div>
    <table class="table table-hover table-responsive table-striped align-middle" id="{{ $tableId }}">
                ...
                <tr>
                    ...
                    <td>
                        ...
                        @if($po->tipe_po == 'penjualan')
                            <span class="badge badge-sm bg-info">Penjualan</span>
                        @else
                            <span class="badge badge-sm bg-warning text-dark">Pembelian</span>
                        @endif
                    </td>
                    <td>
                    ...
                    <td>
                        @php
                            ...
                            $statusLabels = $po->tipe_po == 'penjualan' ? $statusLabelsInternal : $statusLabelsExternal;
                        @endphp
